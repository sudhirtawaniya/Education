...
export default function Cources() {
  ...
  return (
    <>
      ...
      <div
        className="center md:translate-y-[-60%]"
        style={{
          display: "flex",
      ...
      <div className="px-[10%]">
        <h1 className="md:text-[45px] text-[30px] text-[#00a6ae] font-[500] text-center">
      ...
      <div className="shadow-xl p-[2%] my-8">
        <h1 className="md:text-[45px] text-[30px] text-[#00a6ae] font-[500] text-center">
          About {name}
        </h1>
        <hr className="text-black border-b-2" />
        <div>
          <h1 className="md:text-[25px] text-[20px] text-left font-[500] ">
            About Cource
          </h1>
          <p>
            {data.map((data)=>{
