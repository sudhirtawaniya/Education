...
export default function Services() {
    return <>
        ...
        <div className="mask">
         <NavBar/>
          <div className="hero_text md:mt-[10%]  flex-wrap">
          <div>
            <p  className="md:text-[24px] text-center text-[20px]  md:mt-0 mt-[70%]  ">
      ...
      <svg
        ...
        <path
          ...
          clip-rule="evenodd" />
           ...
           <div className="flex justify-center md:w-[70%] my-[5%]">
            <div className="flex justify-around w-full">
              <div className="flex items-center flex-col">

            <img src={group} alt="" className="w-[40px] md:w-[60px]" />
            <p className="text-center">More than 328 Instructors <br /> are Available</p>
            </div>
            <div className="flex items-center flex-col">

            <img src={books} alt="" className="w-[40px] md:w-[60px]" />
            <p className="text-center">More than 3020 Online <br /> Courses Available</p>
            </div>
            <div className="flex items-center flex-col">

            <img src={device} width={100} alt="" className="w-[40px] md:w-[60px]" />
